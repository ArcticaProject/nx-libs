...
void InitOutput(ScreenInfo *scrInfo, int argc, char *argv[])
{
  ...
  if (serverGeneration <= 1)
  {
    ...
    fprintf(stderr, "Copyright (c) 2008-2017 Oleksandr Shneyder <o.shneyder@phoca-gmbh.de>\n");
    fprintf(stderr, "Copyright (c) 2011-2022 Mike Gabriel <mike.gabriel@das-netzwerkteam.de>\n");
    fprintf(stderr, "Copyright (c) 2014-2022 Ulrich Sibiller <uli42@gmx.de>\n");
    fprintf(stderr, "Copyright (c) 2014-2019 Mihai Moldovan <ionic@ionic.de>\n");
